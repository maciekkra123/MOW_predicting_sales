...
lasLosowy <- function(pred_col_name)
{
  ...
  training_data <- read_csv(paste0("Data_raw/no_boruta_zero_nan/DummyTrainingData_", pred_col_name,".csv"))
  test_data <- read_csv(paste0("Data_raw/no_boruta_zero_nan/DummyTestData_", pred_col_name,".csv"))
